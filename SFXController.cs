    ...
    public class SFXController
    {
        ...
        public bool IsMuted
        {
            ...
            set
            {
                if (isMuted != value)
                {
                    ...
                    Log.Info("<color=cyan><b>[GameAudioSystem.Audio.Info]</b></color> 音效{0}静音", value ? "设置" : "取消");
                }
            }
        }
        /// <summary>
        ...
        public bool IsPaused
        {
            ...
            set
            {
                ...
                Log.Info("<color=cyan><b>[GameAudioSystem.Audio.Info]</b></color> 音效{0}", value ? "暂停" : "恢复");
            }
        }
        #endregion
        ...
        public void Stop()
        {
            ...
            Log.Info(message: "<color=cyan><b>[GameAudioSystem.Audio.Info]</b></color> 终止音效播放");
        }

        public AudioHandler Play(AudioClip clip)
        {
            Log.Info("<color=cyan><b>[GameAudioSystem.Audio.Info]</b></color> 播放音效 {0}", clip != null ? clip.name : "--");
            return GetHandler()
                .SetMute(isMuted)
                .SetPause(isPaused)
                .SetClip(clip)
